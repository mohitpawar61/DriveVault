package com.storage.searchservice.controller;

import com.storage.searchservice.client.FileSearchClient;
import com.storage.searchservice.client.FolderSearchClient;
...
public class SearchController {
    ...
    public Map<String,Object> search(@RequestParam String query)
    {
        ...
        List<Map<String, Object>> folderResult = allFiles.stream()
            .filter(f->f.get("name").toString().toLowerCase().contains(query.toLowerCase()))
            .toList();
